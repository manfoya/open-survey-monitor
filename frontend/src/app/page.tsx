  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col items-center text-center space-y-8">
            <div className="space-y-4 max-w-3xl">
              ...
              <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl leading-relaxed">
                Monitor your data collection in <span className="text-primary font-semibold">real-time</span>. 
                Enforce GPS boundaries, track quotas, and validate variables instantly with a robust Python backend.
              </p>
            </div>
      ...
      <section className="bg-muted/30 border-y py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center mb-16 px-4">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Technical Trust</h2>
      ...
      <section className="container mx-auto py-24 text-center">
         <h2 className="text-3xl font-bold tracking-tighter mb-6">Ready to upgrade your monitoring?</h2>
         <Button asChild size="lg" variant="secondary">
            <Link href="https://github.com/manfoya/open-survey-monitor" target="_blank">
              View on GitHub
            </Link>
          </Button>
      </section>
  ...
  return (
    <Card className="bg-card/50 border-muted/60 transition-all hover:bg-card hover:border-border">
      <CardContent className="pt-8">
        <div className="mb-6 p-3 w-fit rounded-lg bg-background/80 shadow-sm ring-1 ring-inset ring-white/10">{icon}</div>
